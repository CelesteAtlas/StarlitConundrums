...
--Monster Zones (yours)
Debug.AddCard(45112597,0,0,LOCATION_MZONE,3,POS_FACEUP_ATTACK,true)
...
Debug.AddCard(25919316,1,1,LOCATION_MZONE,2,POS_FACEUP_ATTACK,true)
local ass = Debug.AddCard(73218989,1,1,LOCATION_MZONE,1,POS_FACEUP_ATTACK,true)
