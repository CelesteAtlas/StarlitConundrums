...
Note: All 3 monsters your opponent controls are unaffected by spell cards and effects. - The deck does not get shuffled.
]]
...
function efilter(e,re)
	return re:IsActiveType(TYPE_SPELL) and re:IsActivated() and re:GetOwner()~=e:GetOwner()
end
...
Debug.ShowHint("Your opponent's monsters are all unaffected by Spell Cards and Effects.")
aux.BeginPuzzle()