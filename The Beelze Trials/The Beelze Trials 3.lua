...
Note: All 3 monsters your opponent controls are unaffected by other monster's effect. - The deck does not get shuffled.
]]
...
Debug.AddCard(35269904,0,0,LOCATION_HAND,0,POS_FACEDOWN) --Triple Tactis Thrust
...
--Backrow (opponent's)
local p1 = Debug.AddCard(53363708, 1, 1, LOCATION_SZONE, 0, POS_FACEUP) --Supermagic Sword of Raptinus 
local p2 = Debug.AddCard(53363708, 1, 1, LOCATION_SZONE, 4, POS_FACEUP) --Supermagic Sword of Raptinus
...
Debug.PreEquip(p1,ass)
Debug.PreEquip(p2,ass)
...
function efilter(e,re)
	return re:IsActiveType(TYPE_MONSTER) and re:IsActivated() and re:GetOwner()~=e:GetOwner()
end
...
Debug.ShowHint("Your opponent's monsters are all unaffected by Monster Effects.")
aux.BeginPuzzle()